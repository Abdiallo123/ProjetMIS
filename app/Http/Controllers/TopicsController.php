    ...
    public function traitement(TopicFormRequest $request)
    {
        ...
        {   
            ...
            /* dd($user->id);*/
             ...
             Topic::create(['titre' => $request->titre, 'type_id' => $request->type, 'contenu_lien' => $request->contenu_lien, 'contenu_fichier' =>$fileName,'user_id' =>$user->id, 'mot_cle' => $request->mot_cle]);
