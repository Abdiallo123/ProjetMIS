...
<?php 
    ...
    if (isset($_POST['sub'])) {
        ...
        $count = $req->rowCount();
        if ($count != 0) {
            $req = $bdd->prepare(" SELECT * FROM admin WHERE password=?");
            $req->execute(array($_POST['pass']));
            $counpass = $req->rowCount();
            if ($counpass != 0) {
                ...
                <div class="content">
                    ...
                    <div id="slideshow">
                        <div class="one">
                            ...
                            <p>Nous vous souhaitons les bienvenue</p>
                        </div>
                        <div class="two">
                            <h2><span>dans Notre</span></h2>
                            <p>dans notre site web </p>
                        </div>
                        <div class="three">
                            <h2><span>site Web </span></h2>
                            <p>connecter vous sur notre site pour etre dans le monde  numeriques</p>
                        </div>
                        <div class="four">
                            <h2><span>la GN</span></h2>
                            <p> plus besoins de vous déplacer pour vos déclaration des naissances </p>
                        </div>
                    </div>
                </div>
                <!-- LOGIN FORM -->
                <div class="user">
                    ...
                    <div class="form-wrap">
                        ...
                        <div class="tabs">
                            ...
                            <h3 class="signup-tab"><a class="sign-up" href="#signup-tab-content"><span>A propos</span></a></h3>
                        </div>
                        <!-- TABS CONTENT -->
                        <div class="tabs-content">
                            ...
                            <div id="login-tab-content" class="active">
                                <form class="login-form" method="POST" action="login.php">
                                    ...
                                    <!-- <input type="text" class="input" id="user_login" placeholder="Username" name="user">


                                    <input type="password" class="input" id="user_pass" placeholder="Password" name="pass">

                                    <input type="checkbox" class="checkbox" checked id="remember_me">

                                    <label for="remember_me">Remember me</label>
                                    <input type="submit" name="sub" class="button" value="Login"> -->

                                    <p><span class="fontawesome-user"></span><input type="text" class="input"  name="user" value="Username" onBlur="if(this.value == '') this.value = 'Username'" onFocus="if(this.value == 'Username') this.value = ''" ></p>
                        
                                    <p><span class="fontawesome-lock"></span><input type="password" class="input" name="pass"  value="Password" onBlur="if(this.value == '') this.value = 'Password'" onFocus="if(this.value == 'Password') this.value = ''"></p> 
                            ...
                            <div id="signup-tab-content">
                                ...
                                <div class="help-action">
                                    ...
                                    <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="agree" href="#">Tout savoir sur le site</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
