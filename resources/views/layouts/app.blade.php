                            ...
                            <ul class="navbar-nav ml-auto navbar-right-top">
                                ...
                                <li class="nav-item dropdown nav-user">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                        ...
                                        <a class="dropdown-item" href="{{ url('/login') }}"><i class="fas fa-user mr-2"></i>Connexion</a>
                                        <a class="dropdown-item" href="{{ url('/register') }}"><i class="fas fa-user mr-2"></i>Inscription</a>
                                        <a class="dropdown-item" href="{{ url('/logout') }}"><i class="fas fa-power-off mr-2"></i>Déconnexion</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                                                ...
                                                                <li class="nav-item">
                                                                    ...
                                                                    <div id="submenu-1-3" class="collapse submenu" style="">
                                                                        <ul class="nav flex-column">
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" href="{{route('archive')}}">Projets archivés</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
